...
class model_v1(nn.Module):
    def __init__(self):
        ...
        self.container = {                          # RF Start = 1
            ...
            "relu": nn.ReLU(),
            "conv6": nn.Conv2d(512,1024,(3,3),1,0),  # Delta RF = +2, Output = (K:512,H:3,W:3)
            "relu": nn.ReLU(),
            ...
            "fc1": nn.Linear(1024*3*3,50),               # Output = 512,10
            "relu": nn.ReLU(),
    ...
    def forward(self,x_train_batch):
        ...
        Y_pred = model(X)   # Instead of writing forward, directly calling forward of sequential
