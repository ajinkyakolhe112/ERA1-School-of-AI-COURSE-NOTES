...
Net                                      --              --                   --         --
├─Sequential: 1-1                        --              --                   --         --
│    └─0.weight                          [10, 1, 3, 3]   └─90
│    └─Conv2d: 2-1                       [3, 3]          90                0.83%         23,400
│    │    └─weight                       [1, 10, 3, 3]   └─90
│    └─ReLU: 2-2                         --              --                   --         --
├─Sequential: 1-2                        --              --                   --         --
│    └─0.weight                          [10, 10, 3, 3]  └─900
│    └─Conv2d: 2-3                       [3, 3]          900               8.34%         216,000
│    │    └─weight                       [10, 10, 3, 3]  └─900
│    └─ReLU: 2-4                         --              --                   --         --
├─Sequential: 1-3                        --              --                   --         --
│    └─0.weight                          [20, 10, 3, 3]  └─1,800
│    └─Conv2d: 2-5                       [3, 3]          1,800            16.68%         792,000
│    │    └─weight                       [10, 20, 3, 3]  └─1,800
│    └─ReLU: 2-6                         --              --                   --         --
├─MaxPool2d: 1-4                         2               --                   --         --
├─Sequential: 1-5                        --              --                   --         --
│    └─0.weight                          [10, 20, 1, 1]  └─200
│    └─Conv2d: 2-7                       [1, 1]          200               1.85%         22,000
│    │    └─weight                       [20, 10, 1, 1]  └─200
│    └─ReLU: 2-8                         --              --                   --         --
├─Sequential: 1-6                        --              --                   --         --
│    └─0.weight                          [10, 10, 3, 3]  └─900
│    └─Conv2d: 2-9                       [3, 3]          900               8.34%         81,000
│    │    └─weight                       [10, 10, 3, 3]  └─900
│    └─ReLU: 2-10                        --              --                   --         --
├─Sequential: 1-7                        --              --                   --         --
│    └─0.weight                          [20, 10, 3, 3]  └─1,800
│    └─Conv2d: 2-11                      [3, 3]          1,800            16.68%         252,000
│    │    └─weight                       [10, 20, 3, 3]  └─1,800
│    └─ReLU: 2-12                        --              --                   --         --
├─Sequential: 1-8                        --              --                   --         --
│    └─0.weight                          [10, 20, 1, 1]  └─200
│    └─Conv2d: 2-13                      [1, 1]          200               1.85%         14,000
│    │    └─weight                       [20, 10, 1, 1]  └─200
│    └─ReLU: 2-14                        --              --                   --         --
├─Sequential: 1-9                        --              --                   --         --
│    └─0.weight                          [10, 10, 7, 7]  └─4,900
│    └─Conv2d: 2-15                      [7, 7]          4,900            45.41%         49,000
